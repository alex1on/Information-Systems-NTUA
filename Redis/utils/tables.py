...
data_types = [
  ...
  "INTEGER, VARCHAR(16), VARCHAR, VARCHAR, VARCHAR(50), INTEGER, INTEGER, VARCHAR(50), VARCHAR(40), INTEGER, VARCHAR(50), VARCHAR(100), VARCHAR(40), INTEGER, VARCHAR(50), VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, DOUBLE",
  ...
  "INTEGER, VARCHAR(16), VARCHAR, VARCHAR, INTEGER, INTEGER, VARCHAR(50), VARCHAR(50), INTEGER, INTEGER, VARCHAR(20), VARCHAR(40), INTEGER, VARCHAR(50), VARCHAR(100), VARCHAR(40), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, DOUBLE",
  "INTEGER, VARCHAR(16), VARCHAR(100)",
  "INTEGER, VARCHAR(16), VARCHAR, VARCHAR, VARCHAR(200), DOUBLE, DOUBLE, INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), VARCHAR(20), VARCHAR(20), VARCHAR(20), VARCHAR(10), VARCHAR(10), INTEGER, VARCHAR(50)",
  "INTEGER, VARCHAR(16), INTEGER, INTEGER, INTEGER, DOUBLE, INTEGER, VARCHAR(50), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(100), VARCHAR(15), VARCHAR(1)",
  "INTEGER, VARCHAR(16), VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, VARCHAR(20)",
  ...
  "INTEGER, VARCHAR(16), VARCHAR, VARCHAR, INTEGER, VARCHAR(50), INTEGER, INTEGER, VARCHAR(20), VARCHAR(40), INTEGER, VARCHAR(100), VARCHAR(100), VARCHAR(40), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), INTEGER, VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, DOUBLE",
  ...
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE",
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE",
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE",
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE",
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE",
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE"
]