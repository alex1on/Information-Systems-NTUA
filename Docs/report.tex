...
% The amount of data in our world has been exploding and analyzing large data set --so called big data-- has
% become a key basis of competition and productivity growth.
...
\subsubsection{\textbf{\underline{Architechture}}}
...
These features make PostgreSQL a very powerful and attractive relational DBMS and that's the reason we selected it for our cluster.
