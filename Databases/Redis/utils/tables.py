...
data_types = [
  "VARCHAR, DATE, VARCHAR, VARCHAR", # dv
  "INTEGER, VARCHAR(16), DATE, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, VARCHAR(9), VARCHAR(6), VARCHAR(1), VARCHAR(1), VARCHAR(1), INTEGER, INTEGER, INTEGER, INTEGER, VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1), VARCHAR(1)", # d 
  ...
  "INTEGER, VARCHAR(16), DATE, DATE, VARCHAR(50), INTEGER, INTEGER, VARCHAR(50), VARCHAR(40), INTEGER, VARCHAR(50), VARCHAR(100), VARCHAR(40), INTEGER, VARCHAR(50), VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, DOUBLE", # web_site
  "INTEGER, VARCHAR(16), DATE, DATE, INTEGER, INTEGER, VARCHAR(1), INTEGER, VARCHAR(100), VARCHAR(50), INTEGER, INTEGER, INTEGER, INTEGER", # wp
  "INTEGER, INTEGER, INTEGER", # ib
  "INTEGER, VARCHAR(16), DATE, DATE, INTEGER, INTEGER, VARCHAR(50), VARCHAR(50), INTEGER, INTEGER, VARCHAR(20), VARCHAR(40), INTEGER, VARCHAR(50), VARCHAR(100), VARCHAR(40), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, DOUBLE", ## cc
  "INTEGER, VARCHAR(16), VARCHAR(100)", # r
  "INTEGER, VARCHAR(16), DATE, DATE, VARCHAR(200), DOUBLE, DOUBLE, INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), VARCHAR(20), VARCHAR(20), VARCHAR(20), VARCHAR(10), VARCHAR(10), INTEGER, VARCHAR(50)", # i
  ...
  "INTEGER, VARCHAR(16), DATE, DATE, INTEGER, VARCHAR(50), INTEGER, INTEGER, VARCHAR(20), VARCHAR(40), INTEGER, VARCHAR(100), VARCHAR(100), VARCHAR(40), INTEGER, VARCHAR(50), INTEGER, VARCHAR(50), VARCHAR(10), VARCHAR(60), VARCHAR(15), VARCHAR(10), VARCHAR(60), VARCHAR(30), VARCHAR(2), VARCHAR(10), VARCHAR(20), DOUBLE, DOUBLE", # s
  ...
  "INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE", # ws
...
mappings = [
  ...
  ([(31, 32)], "warehouse"),                   # warehouse                 --> tpcds.warehouse.w_warehouse_sk:8
