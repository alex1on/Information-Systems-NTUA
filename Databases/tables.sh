...
partition1_pg_tables=(

)

partition1_cass_tables=(

)

partition1_redis_tables=(

)

partition1_cass_tables_structures=(

)

partition2_pg_tables=(

)

partition2_cass_tables=(

)

partition2_redis_tables=(
